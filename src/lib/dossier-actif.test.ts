...
const EVESCOT = { id: "evescot", insee: "17300" };
const SAINT_DOMINIQUE = { id: "saint-dominique", insee: "17300" };
const CREBILLON = { id: "crebillon", insee: "44109" };
const PARIS_7 = { id: "paris7", insee: "75107" };
