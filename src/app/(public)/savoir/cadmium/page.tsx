...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  h1 { font-family:var(--font-serif);font-weight:var(--weight-title);font-size:clamp(40px,6vw,64px);line-height:1.08;letter-spacing:-0.02em;margin:0 0 32px;color:var(--fg-1); }
