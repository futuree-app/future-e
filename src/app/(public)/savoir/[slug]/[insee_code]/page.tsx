...
const css = `
  ...
  *{box-sizing:border-box;}
  ...
  .tag{display:inline-flex;align-items:center;gap:8px;padding:6px 14px;border-radius:100px;font-family:var(--mono);font-size:11px;letter-spacing:0.1em;text-transform:uppercase;}
  .tag::before{content:"";width:6px;height:6px;border-radius:50%;}
  h1{font-family:var(--serif);font-weight:400;font-size:clamp(28px,4vw,48px);line-height:1.1;letter-spacing:-0.02em;margin:0 0 32px;color:var(--text);}
  h2{font-family:var(--serif);font-weight:400;font-size:clamp(22px,2.5vw,30px);line-height:1.2;letter-spacing:-0.01em;margin:48px 0 18px;color:var(--text);position:relative;}
  h2::before{content:"";position:absolute;left:-28px;top:14px;width:14px;height:1px;}
  h3{font-family:var(--sans);font-weight:500;font-size:15px;color:var(--text-muted);letter-spacing:0.06em;text-transform:uppercase;margin:0 0 12px;}
  ...
  .indicator-label{font-family:var(--mono);font-size:10px;letter-spacing:0.1em;text-transform:uppercase;color:var(--text-dim);margin-bottom:12px;}
  ...
  .indicator-value{font-family:var(--serif);font-size:36px;font-weight:400;line-height:1;margin-bottom:4px;}
  ...
  .score-number{font-family:var(--serif);font-size:clamp(64px,10vw,96px);line-height:1;font-weight:400;letter-spacing:-0.03em;position:relative;z-index:1;}
  .score-label{font-family:var(--mono);font-size:12px;letter-spacing:0.08em;text-transform:uppercase;color:var(--text-muted);margin-top:8px;position:relative;z-index:1;}
  .score-context{margin-top:16px;font-size:14px;color:var(--text-muted);position:relative;z-index:1;}
  ...
  .page-footer{position:relative;z-index:2;max-width:800px;margin:0 auto;padding:32px 28px 64px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px;font-family:var(--mono);font-size:11px;color:var(--text-dim);letter-spacing:0.08em;text-transform:uppercase;}
...
export default async function CommunePage({
  ...
  const previewHtml = `
    <div class="article-meta">
      ...
      <span style="font-family:var(--mono);font-size:11px;color:var(--text-dim);letter-spacing:0.08em;text-transform:uppercase;">
        ${commune.departement ?? ''}
      </span>
    </div>
