...
const css = `
  ...
  *{box-sizing:border-box;}
  ...
  .tco-note{padding:12px 16px;font-family:var(--font-mono);font-size:11px;color:var(--fg-4);letter-spacing:0.04em;border-top:1px solid var(--border-1);background:rgba(255,255,255,0.015);}
