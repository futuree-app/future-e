...
- douceur_climat : hivers doux (température moyenne de décembre à février) ; une douceur annuelle ajoute AUSSI faible_chaleur
...
- "famille", "enfant", "élever un enfant", "grandir" → AUCUNE préférence ajoutée. Une situation de foyer n'est pas une demande : elle dit avec qui la personne vit, pas ce qu'elle cherche. Seul l'accès aux collèges et lycées se déduit encore, à poids 1, quand des enfants sont à scolariser (règle plus bas), et il se présente alors comme notre lecture.
- INTERDIT : la seule mention d'une famille, d'enfants ou du fait de grandir n'active JAMAIS eviter_isolement. Une famille peut précisément chercher une maison isolée, et c'est un motif fréquent de départ de la ville. Le moteur pose déjà, de son côté, un plancher de viabilité sur l'isolement : cette déduction le quadruplait et supprimait le plancher partagé avec le bassin d'emploi.
...
- INTERDIT AUSSI : la seule mention d'une famille, d'enfants ou du fait de grandir n'active JAMAIS faible_pression_agricole. Avoir des enfants ne veut pas dire vouloir peser l'agriculture intensive dans le classement de ses communes, et cette préférence modifiait silencieusement les territoires proposés. Elle reste activée par ce que la personne EXPRIME : les pesticides et les cultures traitées (règle plus bas), ou une demande d'environnement sain.
