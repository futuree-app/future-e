...
export async function GET(request: Request) {
  ...
  try {
    ...
    const [georisquesCommune, altitude, zfe, irep, cartofriches, communeData, climateData] = await Promise.all([
      ...
      address.citycode ? getClimatDataCommune(address.citycode).catch(() => null) : null,
    ]);
