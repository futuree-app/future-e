...
// Le contrat de réponse (ApiResponse) vit désormais dans @/lib/logement-report-types
// (LogementReport), partagé avec la route qui le produit. Importé en alias ci-dessus.
