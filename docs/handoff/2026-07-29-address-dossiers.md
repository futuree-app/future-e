> **ARCHIVE.** Ce handoff décrit l'état du 29/07/2026 au soir. Sa section « URGENT : le droit est
> incohérent entre les écrans » est **RÉSOLUE** (commit `d228417`, 30/07), et son chantier hérité
> **C (`checkout-products.ts`) est FAIT** (`da6f079`). Son chantier **A reste ouvert et
> prioritaire**. L'état vivant est dans `docs/handoff/CURRENT.md`.
