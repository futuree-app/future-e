...
Le climat est partout dans l'actualité, nulle part dans nos décisions. Les données existent,
les rapports s'accumulent, mais personne ne sait dire à quelqu'un, dans son quartier, dans sa
vie, ce que ça change concrètement pour lui.

Et au moment de choisir où vivre, où acheter, où élever ses enfants, ce ne sont pas les
informations qui manquent. C'est une façon honnête de les relier. Les données publiques sont
...
Pas un média d'opinion, pas un outil de culpabilisation, pas un dashboard froid pour experts,
ni un générateur de prédictions spectaculaires. Une interface qui transforme des données
