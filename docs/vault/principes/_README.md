...
fonction de test : une nouvelle décision doit pouvoir se vérifier contre eux.

**Garde-fou structurel** : ce dossier tient en **une page**. S'il en dépasse une, c'est
qu'on y fait entrer des préférences déguisées en invariants. La rareté est la fonctionnalité.
